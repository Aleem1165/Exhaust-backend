...
const cloudinary_folder = 'Exhaust/Sounds'; 
...
module.exports = (req, res, next) => {
    try {
        upload.single('sound')(req, res, (err) => { 
            ...
            if (!req.file) {
                return res.json({ success: false, message: '*Sound required.' });
            }
            ...
            cloudinary.uploader.upload(
                ...
                (cloudinaryErr, cloudinaryResult) => {
                    ...
                    return res.json({ success: true, message: 'Sound uploaded successfully.', url: cloudinaryResult.secure_url });
                }
            );
        });
    } catch (error) {
